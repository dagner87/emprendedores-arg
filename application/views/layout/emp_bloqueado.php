...
<section id="wrapper" class="login-register">
  ...
  <div class="login-box">
    ...
    <div class="white-box" style=" color: #005596; ">
                    <h3 style=" color: #005596; " class="box-title m-b-0">Entrada al sistema</h3>
                            <?php 
 ...
 <script>
    ...
    $(document).ready(function() {
     ...
     function sweetalertsuccess() {
        swal({
           title: "Debe Firmar el Contrato!",   
            text: "Para poder tener acceso al panel debe primeramente firmar el contrato con su representante", 
            type: "info",   

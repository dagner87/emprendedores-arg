                            ...
                            <div class="panel-footer">
                                <ul class="list-task todo-list list-group m-b-0" data-role="tasklist">
                                    <li class="list-group-item" data-role="task">
                                        ...
                                        <ul class="assignedto">
                                            <li><img src="<?php echo base_url();?>assets/plugins/images/users/1.jpg" alt="user img" data-toggle="tooltip" data-placement="top" title="Steave" /></li>
                                            <li><img src="<?php echo base_url();?>assets/plugins/images/users/2.jpg" alt="user img" data-toggle="tooltip" data-placement="top" title="Jessica" /></li>
                                            <li><img src="<?php echo base_url();?>assets/plugins/images/users/3.jpg" alt="user img" data-toggle="tooltip" data-placement="top" title="Priyanka" /></li>
                                            <li><img src="<?php echo base_url();?>assets/plugins/images/users/4.jpg" alt="user img" data-toggle="tooltip" data-placement="top" title="Selina" /></li>
                                        </ul>
                                    </li>
                                    <li class="list-group-item" data-role="task">
                                        <div class="checkbox checkbox-info">
                                        ...
                                        <ul class="assignedto">
                                            <li><img src="<?php echo base_url();?>assets/plugins/images/users/3.jpg" alt="user ing" data-toggle="tooltip" data-placement="top" title="Priyanka" /></li>
                                            <li><img src="<?php echo base_url();?>assets/plugins/images/users/4.jpg" alt="user img" data-toggle="tooltip" data-placement="top" title="Selina" /></li>
                                        </ul>
                                    </li>
                                    <li class="list-group-item" data-role="task">
                                    ...
                                    <li class="list-group-item" data-role="task">
                                        ...
                                        <ul class="assignedto">
                                            <li><img src="<?php echo base_url();?>assets/plugins/images/users/1.jpg" alt="user img" data-toggle="tooltip" data-placement="top" title="Assign to Steave" /></li>
                                            <li><img src="<?php echo base_url();?>assets/plugins/images/users/2.jpg" alt="user img" data-toggle="tooltip" data-placement="top" title="Assign to Jessica" /></li>
                                            <li><img src="<?php echo base_url();?>assets/plugins/images/users/4.jpg" alt="user img" data-toggle="tooltip" data-placement="top" title="Assign to Selina" /></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="steamline">
                                    ...
                                    <div class="sl-item">
                                        ...
                                        <div class="sl-right">
                                            ...
                                            <div class="row inline-photos">
                                                <div class="col-xs-4"><img class="img-responsive" alt="user" src="<?php echo base_url();?>assets/plugins/images/small/vd1.jpg"></div>
                                                <div class="col-xs-4"><img class="img-responsive" alt="user" src="<?php echo base_url();?>assets/plugins/images/small/vd2.jpg"></div>
                                                <div class="col-xs-4"><img class="img-responsive" alt="user" src="<?php echo base_url();?>assets/plugins/images/small/vd3.jpg"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="sl-item">
                                        <div class="sl-left"> <img class="img-circle" alt="user" src="<?php echo base_url();?>assets/plugins/images/users/sonu.jpg"> </div>
                                        <div class="sl-right">
                                    ...
                                    <div class="sl-item">
                                        <div class="sl-left"> <img class="img-circle" alt="user" src="<?php echo base_url();?>assets/plugins/images/users/ritesh.jpg"> </div>
                                        <div class="sl-right">
                                    ...
                                    <div class="sl-item">
                                        <div class="sl-left"> <img class="img-circle" alt="user" src="<?php echo base_url();?>assets/plugins/images/users/govinda.jpg"> </div>
                                        <div class="sl-right">
                                ...
                                <div class="panel-body">
                                    <div class="chat-box" style="height: 510px;">
                                        <ul class="chat-list slimscroll" style="overflow: hidden;" tabindex="5005">
                                            <li>
                                                <div class="chat-image"> <img alt="male" src="<?php echo base_url();?>assets/plugins/images/users/sonu.jpg"> </div>
                                                <div class="chat-body">
                                                    <div class="chat-text">
                                                        <h4>Sonu Nigam</h4>
                                            ...
                                            <li class="odd">
                                                <div class="chat-image"> <img alt="Female" src="<?php echo base_url();?>assets/plugins/images/users/genu.jpg"> </div>
                                                <div class="chat-body">
                                                    <div class="chat-text">
                                                        <h4>Genelia</h4>
                                            ...
                                            <li>
                                                <div class="chat-image"> <img alt="male" src="<?php echo base_url();?>assets/plugins/images/users/ritesh.jpg"> </div>
                                                <div class="chat-body">
                                                    <div class="chat-text">
                                                        <h4>Ritesh</h4>

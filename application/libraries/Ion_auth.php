...
class Ion_auth
{
	...
	public function register_rev( $id_usuario,$identity, $password, $email, $activation_code,$first_name, $last_name, $company, $phone) //need to test email activation
	{
		
		$id = $this->ion_auth_model->register_rev( $id_usuario,$identity, $password, $email, $activation_code,$first_name, $last_name, $company, $phone);
		if($id==0){
			return FALSE;
		}else{
			return TRUE;
